...
page: 514
headings: ["8.1.4.2 Fixed Capacity Management"]
---
...
media component for which the controller repor ts wear information (refer to the Available Spare field and
the Percentage Used field in the Media Unit Status Descriptor, Figure 255).
