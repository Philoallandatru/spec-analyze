...
page: 187
headings: ["4.7 NVMe Qualified Names"]
---
...
07:04 Namespace Identifier 1: This field contains the second lowest namespace ID in the list or 0h if the
list contains less than two entries.
… …
(N*4+3):(N*4) Namespace Identifier N: This field contains the largest namespace ID in the list or 0h if the list
contains less than N+1 entries.
